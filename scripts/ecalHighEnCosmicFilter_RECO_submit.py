...
def main():
 ...
 # put here your configuration directory
 # confdir = "/afs/cern.ch/user/c/ccecal/cafafs/CRUZET_devel/src/CaloOnlineTools/EcalTools/test/"
 confdir = "/afs/cern.ch/cms/CAF/CMSCOMM/COMM_ECAL/ccecal/CRUZET_devel/src/CaloOnlineTools/EcalTools/test"
 ...
 for jobcount in range(n):
      ...
      args=['bsub','-q8nh',"-odummyo","-edummye",workdir+'/ecalHighEnCosmicFilter_RECO.csh',conffile,logfile,workdir,outputfile,destdir]   
